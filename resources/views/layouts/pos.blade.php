    ...
    <main class="flex min-h-screen min-w-0 flex-1 flex-col">
        ...
        <div class="flex-1 p-4 lg:p-6">
            ...
            <div class="fixed top-5 right-4 sm:right-5 z-50 flex flex-col gap-3 w-full sm:w-80 max-w-[calc(100vw-2rem)] sm:max-w-full pointer-events-none">
                @if(session('success'))
                    <div x-data="flash" x-show="show" x-transition.opacity.duration.500ms class="pointer-events-auto flex items-start gap-3 p-4 rounded-xl shadow-lg border bg-emerald-50 border-emerald-200 text-emerald-800">
                ...
                @if($errors->any())
                    <div x-data="flash" x-show="show" x-transition.opacity.duration.500ms class="pointer-events-auto flex items-start gap-3 p-4 rounded-xl shadow-lg border bg-red-50 border-red-200 text-red-800">
