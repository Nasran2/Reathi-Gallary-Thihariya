...
<div x-data='pos(@json($catalog),"{{ $type }}", @json($methods))' class="-m-4 lg:-m-8" @keydown.window="handleKey($event)">
 ...
 <div class="max-h-[42vh] min-h-48 overflow-y-auto p-4">
    <template x-for="(line,i) in cart" :key="line.lineKey">
        <div class="mb-2 flex items-center justify-between rounded-xl border border-slate-100 p-2 hover:bg-slate-50 transition">
            ...
            <div class="flex-1 cursor-pointer pr-2" @click="openEditModal(i)">
