...
<div class="flex justify-between items-center mb-5">
    <div>
        <h1 class="font-serif text-3xl text-ink">Customer Due Report</h1>
        <p class="text-sm text-slate-500">View total outstanding balances grouped by customer</p>
    </div>
...
@component('reports.filters')
    ...
    <div class="w-full text-xs text-slate-500 mt-2 italic">
        * Note: Date filters are typically not applied to customer balances as they represent current total snapshots.
    </div>
@endcomponent

<div class="card overflow-hidden">
    <div class="overflow-x-auto">
        @include('reports.customer-due-table')
    </div>
</div>
@endsection
