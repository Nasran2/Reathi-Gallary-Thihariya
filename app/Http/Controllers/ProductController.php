    ...
    private function syncUnits(Product $product, array $additionalUnits): void
    {
        ...
        foreach ($additionalUnits as $unit) {
            $product->productUnits()->create([
                ...
                'main_price' => $unit['main_price'] ?? null,
                'remnant_price' => $unit['remnant_price'] ?? null,
