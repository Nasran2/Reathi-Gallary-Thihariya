...
class DashboardController extends Controller
{
    public function __invoke()
    {
        ...
        $upcomingCheques = Cheque::with('customer', 'supplier', 'endorsements.supplier')->whereIn('status', ['pending', 'deposited', 'endorsed'])->whereDate('cheque_date', '<=', today()->addDays(2))->orderBy('cheque_date')->get();
